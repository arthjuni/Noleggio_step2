...
INSERT INTO `django_session` VALUES ('a3gtgvjpbp2dxxbik8pgqplypmrhxdbd','NTMxZTc3YTIwMjA3NzUzOTQxNmJiY2JiNWExMDQzY2UxYjgzNzNlMjp7Il9hdXRoX3VzZXJfaWQiOiIyIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI0NmYxYWM4ZDg1YzFiODAzNDYxZTE1NjMxOGJjMzBhZGZiM2JlYWVjIn0=','2020-03-10 12:48:27.877051'),('ha62adlj51oftam0ff570o9z0g6eothz','NmI5ZDU1YmRkMTQ5ZGJiNzlhNGFhN2VmMWMwMjM1YjU2OTEzZDJhNTp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI0NGRlNzkzNmZhNTE3M2VhNjMyM2EwNjE4ZTc4YWNjOTdlODc4YzU3In0=','2020-03-09 06:34:27.167283'),('icy71nve4la6o4yf71td4prpz8dg324j','NmI5ZDU1YmRkMTQ5ZGJiNzlhNGFhN2VmMWMwMjM1YjU2OTEzZDJhNTp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiI0NGRlNzkzNmZhNTE3M2VhNjMyM2EwNjE4ZTc4YWNjOTdlODc4YzU3In0=','2020-03-09 08:50:45.190653');
...
INSERT INTO `shop_articolo` VALUES ('2020-02-24 10:11:38.000000',1,50,1,1),('2020-02-24 10:06:37.000000',2,50,1,2),('2020-02-24 11:47:04.000000',3,50,3,4),('2020-02-24 11:47:25.000000',4,50,3,5),('2020-02-24 12:26:19.000000',5,100,2,1),('2020-02-24 12:26:46.000000',6,100,2,2),('2020-02-24 12:27:02.000000',7,100,2,3),('2020-02-24 12:27:14.000000',8,100,2,4),('2020-02-24 12:27:33.000000',9,100,2,5),('2020-02-25 00:00:00.000000',10,7,5,5);
...
--
-- Temporary view structure for view `shop_listvideomercelav`
--

DROP TABLE IF EXISTS `shop_listvideomercelav`;
/*!50001 DROP VIEW IF EXISTS `shop_listvideomercelav`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `shop_listvideomercelav` AS SELECT 
 1 AS `listvideomercelav_id`,
 1 AS `Nome`,
 1 AS `Nome_localita`,
 1 AS `Autore`,
 1 AS `CasaProdutrice`,
...
INSERT INTO `shop_merce` VALUES (1,100,'2020-02-24 10:10:36.000000',3,3),(2,500,'2020-02-24 11:45:29.000000',2,1),(3,100,'2020-02-24 11:46:00.000000',1,2),(4,5,'2020-02-20 00:00:00.000000',3,1),(5,300,'2020-02-20 00:00:00.000000',3,1);
...
INSERT INTO `shop_video` VALUES (1,'Diouf Fall','ben affar','liongate',140,'Action','La vita o la Guerra','2020-02-24 10:05:24.000000',50,'film d\'action'),(2,'arth juni','ben siddi','liongate',70,'Fantasy','Marte','2010-02-24 10:06:37.000000',50,'la vita su marte'),(3,'will smith','brice lee','RAI1',60,'Action','lLa vita','2015-12-13 00:00:00.000000',70,'film comico'),(4,'Arnold S','will smith ,raya kakuta','TF1',80,'Romance','Gestapo','2019-05-15 00:00:00.000000',50,'duex2'),(5,'Freeman','bili jams','TG1',60,'orror','Suangue','2010-05-10 00:00:00.000000',60,'film  di vampir'),(6,'brice willis','rambo','tvjojo',130,'Action','rambo2','2020-02-25 00:00:00.000000',60,'film di action e di fantasma');
...
--
-- Final view structure for view `shop_listvideomercelav`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`E2IKIWHIWB`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `shop_listvideomercelav` AS select `shop_articolo`.`Articolo_id` AS `listvideomercelav_id`,`shop_puntovendita`.`Nome` AS `Nome`,`shop_localita`.`Nome_localita` AS `Nome_localita`,`shop_video`.`Autore` AS `Autore`,`shop_video`.`CasaProdutrice` AS `CasaProdutrice`,`shop_video`.`Description` AS `Description`,`shop_video`.`Durata` AS `Durata`,`shop_video`.`Genere` AS `Genere`,`shop_video`.`Regista` AS `Regista`,`auth_user`.`username` AS `username`,`shop_video`.`Prezzo_listino` AS `Prezzo_listino`,`shop_merce`.`Quantita` AS `quantita_merce`,`shop_articolo`.`Quantita` AS `quantita_articolo`,`shop_fornitore`.`Nome` AS `Nome_fornitura`,`shop_video`.`Titolo` AS `Titolo` from (((((((`shop_puntovendita` left join `shop_merce` on((`shop_merce`.`Punto_vendita_id` = `shop_puntovendita`.`Punto_vendita_id`))) left join `shop_articolo` on((`shop_articolo`.`Merce_id` = `shop_merce`.`Merce_id`))) left join `shop_fornitore` on((`shop_fornitore`.`Fornitore_id` = `shop_merce`.`Fornitore_id`))) left join `shop_video` on((`shop_video`.`Video_id` = `shop_articolo`.`Video_id`))) left join `shop_localita` on((`shop_localita`.`Localita_id` = `shop_puntovendita`.`Localita_id`))) left join `shop_lavoratore` on((`shop_puntovendita`.`Punto_vendita_id` = `shop_lavoratore`.`Punto_vendita_id`))) left join `auth_user` on((`auth_user`.`id` = `shop_lavoratore`.`utente_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-02-25 17:47:01
